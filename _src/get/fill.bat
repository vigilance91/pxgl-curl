...
rem 
set "_URL_ARGS=w=%_CLI_WIDTH%&h=%_CLI_HEIGHT%&r=%_CLI_RED%&g=%_CLI_GREEN%&b=%_CLI_BLUE%"
rem 
if defined _CLI_PATH (
    curl --get "https://vigilstudios.ca/pxgl-php56/fill.php?%_URL_ARGS%" --output "%_CLI_PATH%" || (
        if not defined _CLI_QUIET (
